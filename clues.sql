...
SELECT name FROM countries WHERE region = 'Souther
n Europe' ORDER BY population ASC LIMIT 1;

-- Clue #2: Now that we're here, 
-- we have insight that Carmen was seen attending language
...
SELECT * FROM countrylanguages WHERE countrycode='
VAT';
...
-- One is named the same as the country –
-- that would be too obvious. We're following our gut on this one;
...
-- -- the capital! Look up the country's capital, 
...
-- We have one chance to catch her, 
...
-- and I'm sure she thinks she's very clever,
...
-- Find out where she's headed, send us the info, 
